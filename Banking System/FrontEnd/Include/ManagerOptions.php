...
<main>
    <div>
        ...
        <button type="submit" name="employee_create">Add</button>
        </form>
    </div>
    ...
    <div>
        ...
        <button type="submit" name="employee_edit">Edit</button>
        </form>
    </div>
    ...
    <div>
        ...
        <button type="submit" name="employee_delete">Remove</button>
        </form>
    </div>
</main>
